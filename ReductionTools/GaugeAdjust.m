...
ToUnitaryGauge[ ring_FusionRing, FSymb_, opts:OptionsPattern[] ] :=
  Module[{
    ...
    newBinomialConstraints, newSumConstraints, newVars,revertVars,newGaugeVars,revertGaugeVars,
    numericQ, simplify, acc, binomialMat, trivialityConditions,newTrivialityConditions,
    ...
    Catch[
      ...
      If[ (* Already have unitary gauge *)
        ...
        If[
          returnTransformQ,
          { FSymb, Thread[ GetVars[ transforms, g ] -> 1 ] },
          FSymb
        ]
      ];
      ...
      *)
      ...
      { binomialMat, rhsVec } =
        AddOptions[opts][MonPolEqnsToSemiExponentiatedSystem][
      ...
      CSpace =
        IntOrthogonalSpace[ mV[[ ;;, rankBinomialMat+1;; ]], trivialGaugeSpace ];
...
WhichGaugeTransform[ ring_, sol1_, sol2_, g_, opts:OptionsPattern[] ] :=
  ...
  AbsoluteTiming[
    ...
    Catch[
      ...
      CSpace =
      IntOrthogonalSpace[ mV[[ ;;, rankBinomialMat+1;; ]], trivialSpace ];
      ...
      If[ (* Any solution goes *)
        ...
        If[ (* All extra vars are already phases *)
          ...
          FindInstance[
            ...
            GetVars[ normSquaredExtraVars, { a, b } ],
            Reals
          ];
...
Options[ FixUnitaryRSymbols ] = { "RSymbols" -> None };
FixUnitaryRSymbols[ ring_, OptionsPattern[] ] :=
